...
namespace BigioHrServices.Migrations
{
    ...
    [Migration("20230322072239_AddTableLeave")]
            ...
            modelBuilder.Entity("BigioHrServices.Db.Entities.Position", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            Code = "001",
                            CreatedDate = new DateTime(2023, 3, 22, 7, 22, 39, 426, DateTimeKind.Utc).AddTicks(4623),
                            IsActive = true,
                            Level = 2,
                            Name = "Pegawai"
                        },
                        new
                        {
                            Id = 2L,
                            Code = "002",
                            CreatedDate = new DateTime(2023, 3, 22, 7, 22, 39, 426, DateTimeKind.Utc).AddTicks(4647),
                            IsActive = true,
                            Level = 1,
                            Name = "Supervisor"
                        });
