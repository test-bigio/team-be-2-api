...
namespace BigioHrServices.Migrations
{
    ...
    [Migration("20230322082831_UpdateEmployeeAddIsOnLeave")]
    partial class UpdateEmployeeAddIsOnLeave
    {
            ...
            modelBuilder.Entity("BigioHrServices.Db.Entities.Position", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            Code = "001",
                            CreatedDate = new DateTime(2023, 3, 22, 8, 28, 31, 472, DateTimeKind.Utc).AddTicks(9437),
                            IsActive = true,
                            Level = 2,
                            Name = "Pegawai"
                        },
                        new
                        {
                            Id = 2L,
                            Code = "002",
                            CreatedDate = new DateTime(2023, 3, 22, 8, 28, 31, 472, DateTimeKind.Utc).AddTicks(9463),
                            IsActive = true,
                            Level = 1,
                            Name = "Supervisor"
                        });
