...
namespace BigioHrServices.Migrations
{
    ...
    [Migration("20230322080018_AddTableNotification")]
            ...
            modelBuilder.Entity("BigioHrServices.Db.Entities.Position", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            Code = "001",
                            CreatedDate = new DateTime(2023, 3, 22, 8, 0, 18, 208, DateTimeKind.Utc).AddTicks(674),
                            IsActive = true,
                            Level = 2,
                            Name = "Pegawai"
                        },
                        new
                        {
                            Id = 2L,
                            Code = "002",
                            CreatedDate = new DateTime(2023, 3, 22, 8, 0, 18, 208, DateTimeKind.Utc).AddTicks(701),
                            IsActive = true,
                            Level = 1,
                            Name = "Supervisor"
                        });
